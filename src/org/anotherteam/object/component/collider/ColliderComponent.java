...
public final class ColliderComponent extends AABB {
    ...
    public ColliderComponent(@NonNull Vector2i position){
        super(position);
        solid = false;
    ...
    public boolean isCollide(@NonNull ColliderComponent aabb, @NonNull Vector2f moveVector){
    ...
    public boolean isCanInteract(@NonNull ColliderComponent collider){
    ...
    public void checkInteract() {
        for (val object : ownerObject.getLevel().getGameObjects()) {
            ...
            val collider = object.getComponent(ColliderComponent.class);
    ...
    private static class InteractAABB extends AABB {
        ...
        private final ColliderComponent ownerCollider;

        public InteractAABB(@NonNull ColliderComponent ownerCollider){
        ...
        public boolean isInteract(@NonNull ColliderComponent otherCollider){
