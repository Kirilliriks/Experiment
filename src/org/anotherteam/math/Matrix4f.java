...
public final class Matrix4f {
    ...
    public static Matrix4f translate(Vector2i translate) {
    ...
    public static Matrix4f rotate(float angle, Vector3f axis) {
        ...
        val cos = (float) Math.cos(Math.toRadians(angle));
        val sin = (float) Math.sin(Math.toRadians(angle));
        val C = 1 - cos;
    ...
    public static Matrix4f transform(Vector2i position) {
