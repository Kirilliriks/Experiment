...
public final class ImGuiEditor {
    ...
    public ImGuiEditor(@NotNull Game game, @NotNull Window window) {
        this.game = game;
        this.window = window;
    }
    ...
    public void init() {
        ...
        io.setIniFilename(null); // Put if need save Editor window's "umgui.ini"
    ...
    private void startFrame(final float deltaTime) {
        final float[] winWidth = {window.getWidth()};
